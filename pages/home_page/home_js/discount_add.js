...
async function validateDiscountCode(event) {
  ...
  try {
      ...
      if (data.valid) {
        ...
        setTimeout(() => {feedbackMessage.textContent = "Applying Discount 3s..."; feedbackMessage.style.color = "blue"; setTimeout(() => {feedbackMessage.textContent = "Applying Discount 2s..."; feedbackMessage.style.color = "blue"; setTimeout(() => {feedbackMessage.textContent = "Applying Discount 1s..."; feedbackMessage.style.color = "blue";}, 2000);}, 2000);}, 2000);
